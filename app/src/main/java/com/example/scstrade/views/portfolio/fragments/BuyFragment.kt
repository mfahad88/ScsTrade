...
import com.example.scstrade.databinding.FragmentBuyBinding
            ...
            when(result){
                ...
                is Resource.Success -> {
                    binding.recyclerView.apply {
                        ...
                        adapter = BuyAdapter(result.data?.filter { it.portfolioSymbol.equals((requireActivity() as EditBuySellActivity).symbol,true) }?.filter { it.portfolioType.equals("BUY",true) }?: emptyList(),
                            onItemEdit = {
